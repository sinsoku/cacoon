================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Cacoon プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Cacoon には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Cacoon アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Cacoon.h
   ...
   CacoonApp アプリケーション クラスを宣言します。

Cacoon.cpp
   これは、アプリケーション クラス CacoonApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Cacoon.ico
   ...
   アイコンはメイン リソース ファイル Cacoon.rc に含まれていま
   す。
...
CacoonDoc.h, CacoonDoc.cpp - ドキュメント
   これらのファイルは CacoonDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CacoonDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

CacoonView.h, CacoonView.cpp - ドキュメントのビュー
   これらのファイルは CacoonView クラスを含みます。
   CacoonView オブジェクトは CacoonDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Cacoon.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
